# Relatório de Status — ClickUp
> Gerado em: 03/03/2026, 20:03:00
...
- ✅ **Criar quadro de gestão "Gestão Catalyst" no ClickUp** — Cléber Donato (Sem prazo)
- ✅ **Ata & Transcrição: ATA DE REUNIÃO DE ALTA FIDELIDADE - 19/02/2026 (19/02/2026)** — Cléber Donato (Sem prazo)
- ⬜ **Apresentação da Nova Identidade Visual (VIDI/Cúpula)** — Cléber Donato (25/02/2026)
- ⬜ **Contratação de Editor** — Ana Dias, João Victor Lopes Rosa (Sem prazo)
- ⬜ **Abertura de conta - C6 BANK** — Ana Dias (Sem prazo)
- ✅ **Acompanhamento de Gravação – Studio (12/02)** — Ana Dias (Sem prazo)
- ✅ **Licenças Microsoft e TI** — Ana Dias (Sem prazo)
- ✅ **Tráfego Pago - Correção contratual e pagamento** — Ana Dias, Luiz Portal (Sem prazo)
- ✅ **Contrato equipe interna** — Ana Dias (Sem prazo)
- ✅ **Pagamento de Guias Municipais** — Ana Dias (Sem prazo)
- ✅ **Validação contábil para liberação de cartão CNPJ Catalyst** — Ana Dias (Sem prazo)
- ✅ **Emissão e Ativação de Certificado Digital** — Ana Dias (Sem prazo)
- ✅ **Ajustes de Contrato – Prestação de Serviços Contábeis** — Ana Dias (Sem prazo)
- ✅ **Ajustes Contábeis para Emissão de CNPJ Catalyst** — Ana Dias (Sem prazo)
- ⬜ **Abertura de Conta – Banco Safra** — Ana Dias (Sem prazo)
- ✅ **Constituição Jurídica e Societária Catalyst** — Ana Dias (Sem prazo)
- ⬜ **Definir materiais pré-evento e pós-evento (kits, crachás, brindes)** — Ecossistema Live, Luiz Portal (Sem prazo)
- ⬜ **Luís aprender a operar ClickUp (relatórios, filtros, etiquetas)** — Luiz Portal (Sem prazo)
...
- ⬜ **Cavalo de Raça** — Sem responsável (Sem prazo)
- ⬜ **WTC** — Sem responsável (Sem prazo)
- ⬜ **K Hotel - Ibrahim pediu para não ser.** — Sem responsável (Sem prazo)
- ⬜ **Contato com Buzz Editora - Marisa Marianno** — João Victor Lopes Rosa (Sem prazo)
- ⬜ **Contato com @em2producoes - Enilze Cunha** — João Victor Lopes Rosa (Sem prazo)
- ⬜ **Desenvolvimento do agente de CS** — Cléber Donato (Sem prazo)
- ⬜ **Definir e convidar palestrantes e host.** — João Victor Lopes Rosa (Sem prazo)
- ⬜ **Organizar e estruturar staff do evento.** — João Victor Lopes Rosa (Sem prazo)
- ⬜ **Definir e reservar local do evento.** — João Victor Lopes Rosa (Sem prazo)
...
### 📋 Eventos presenciais (0 tasks)

_Nenhuma task encontrada._

### 📋 Comercial & Vendas (0 tasks)

_Nenhuma task encontrada._

### 📋 Marketing & Tráfego (0 tasks)
...
- ✅ **1ª reunião com OOT para definição e Briefing (02/03/26)** — Ecossistema Live, Luiz Portal (Sem prazo)
- ✅ **Adicionar ebooks ao NotebookLM** — Cléber Donato (Sem prazo)
- ⬜ **Finalizar montagem da equipe comercial ** — Luiz Portal, João Victor Lopes Rosa (03/03/2026)
- ⬜ **Definir situação da Jéssica (flexibilizar ou desligar)** — Luiz Portal (Sem prazo)
- ✅ **Definir nome** — Sem responsável (Sem prazo)
- ⬜ **Desenvolvimento do agente de CS com IA** — Cléber Donato (19/03/2026)
- ✅ **Assinatura do contrato de Tráfego pago** — Luiz Portal (18/02/2026)
- ✅ **Baixar PDFs das obras de referência** — Sophia Viana Pedrosa (Sem prazo)
- ⬜ **Roteirização das aulas** — Luiz Portal, Cléber Donato, Ecossistema Live (Sem prazo)
...
- ⬜ **Ata Publicada: ATA DE REUNIÃO DE ALTA FIDELIDADE - 19/02/2026** — Sem responsável (Sem prazo)
- ⬜ **Viagem SP — Entender engenharia de parcerias com Marcelo** — Luiz Portal (24/02/2026)
- ⬜ **Contatar restaurantes para evento (República da Saúde, Reserva 35, Casa Dips)** — João Victor Lopes Rosa (Sem prazo)
- ✅ **Reunião de alinhamento com a equipe 19/02** — Sem responsável (Sem prazo)
