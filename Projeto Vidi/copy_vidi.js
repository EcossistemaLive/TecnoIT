...
const sourceBase = path.resolve(__dirname, "../../Gestor de projeto");
const targetBase = path.resolve(__dirname, "Arquivos_Gestor_De_Projeto");
...
for (const file of files) {
    ...
    if (fs.existsSync(sourcePath)) {
        ...
        console.log(`Não encontrado: ${file} (procurado em ${sourcePath})`);
    }
}
