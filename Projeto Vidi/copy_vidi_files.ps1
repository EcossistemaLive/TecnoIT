...
$sourceDir = "C:\Users\clebe\OneDrive\Área de Trabalho\ProjetosGit\Gestor de projeto"
$targetDir = "C:\Users\clebe\OneDrive\Área de Trabalho\ProjetosGit\TecnoIT\Projeto Vidi\Arquivos_Gestor_De_Projeto"
...
foreach ($file in $files) {
    try {
        ...
        Write-Host "Erro ao processar $file"
    }
}
